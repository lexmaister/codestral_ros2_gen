...
class NetworkScannerNode(Node):
    def __init__(self):
        ...
        self.get_logger().info('Network scanner node started. Publishing every 5 seconds.')
    ...
    def publish_status(self):
        ...
        self.get_logger().info(f'Published status for 192.168.1.1 as {ip_status.status}')
